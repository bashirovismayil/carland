...
class Translations {
  static final Map<String, Map<String, String>> translations = {
    ...
    AppStrings.lastServiceMileageMustNotBeGreaterThan: {
      ...
      'ru':
          'Пробег при последнем обслуживании не должен быть больше текущего пробега:',
    },
    ...
    AppStrings.neverServicedInfoMessage: {
      'az':
          'Əgər maşının yenidirsə və ya ümumiyyətlə bu xidmət növü üzrə avtomobilin servisdə olmayıbsa, bu bəndi seç',
      'en':
