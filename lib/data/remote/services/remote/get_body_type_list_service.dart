  ...
  Future<List<GetBodyTypeListResponse>> getBodyTypeList() async {
    ...
    try {
      ...
      if (resp.statusCode.isSuccess) {
        ...
        return data
            .map((item) => GetBodyTypeListResponse.fromJson(
            item as Map<String, dynamic>))
            .toList();
      } else {
        final message = _getErrorMessage(resp.statusCode ?? 0);
        throw Exception('Get body type list failed: $message');
      }
      ...
      if (e.response != null) {
        ...
        throw Exception('Get body type list failed: Şəbəkə xətası');
      }
    }
  }
