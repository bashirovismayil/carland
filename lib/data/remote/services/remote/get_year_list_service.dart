  ...
  Future<List<GetYearListResponse>> getYearList() async {
    ...
    try {
      ...
      if (resp.statusCode.isSuccess) {
        ...
        return data
            .map((item) => GetYearListResponse.fromJson(
            item as Map<String, dynamic>))
            .toList();
      } else {
        final message = _getErrorMessage(resp.statusCode ?? 0);
        throw Exception('Get year list failed: $message');
      }
      ...
      if (e.response != null) {
        ...
        throw Exception('Get year list failed: Şəbəkə xətası');
      }
    }
  }
