...
import '../../cubit/terms/terms_conditions_state.dart';
...
class _TermsConditionsPageState extends State<TermsConditionsPage> {
    ...
    return Scaffold(
      ...
      body: BlocBuilder<TermsConditionsCubit, TermsConditionsState>(
        builder: (context, state) {
          ...
          } else if (state is TermsConditionsSuccess) {
            return _buildTermsContent(state.termsData);
  ...
  Widget _buildTermsContent(TermsConditionsResponse terms) {
        ...
        children: [
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                const SizedBox(height: 8),
                ...terms.sections.asMap().entries.map((entry) {
