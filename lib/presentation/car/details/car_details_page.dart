...
class CarDetailsPage extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final plateController = useTextEditingController(text: carData.plateNumber ?? '');
    ...
    final transmissionController = useTextEditingController(text: carData.transmissionType ?? '');
    final engineTypeController = useTextEditingController(text: carData.engineType ?? '');
                        ...
                        children: [
                          ...
                          Expanded(
                            child: _buildTextField(
                              ...
                              validator: (value) {
                                if ((fieldRequirements['color'] ?? false) &&
                                    (value == null || value.trim().isEmpty)) {
  ...
  Widget _buildBottomSection(BuildContext context, GlobalKey<FormState> formKey) {
    return Container(
      ...
      child: Column(
        children: [
          ...
          CustomElevatedButton(
            height: 58,
              onPressed: () => Go.replaceAndRemove(context, UserMainNavigationPage()),
